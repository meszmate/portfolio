...
function MiniTitle({children}: {children: React.ReactNode}){
    return <h2 className="mb-6 text-sm font-semibold text-white uppercase">
        {children}
    </h2>
}
function Logo({children}: {children: React.ReactNode}) {
    return <Link href={"#"} className="text-gray-500 hover:text-white">
        {children}
    </Link>
}
...
export default function Footer() {
    return <>
        <footer className="bg-gray-900">
            <div className="mx-auto w-full max-w-[1500px] p-8 py-6 lg:py-8">
                <div className="md:flex md:justify-between">
                <div className="mb-6 md:mb-0">
                    <a href="https://github.com/meszmate/portfolio" className="flex items-center gap-4">
                ...
                <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                    ...
                    <div>
                        <MiniTitle>Find me on</MiniTitle>
                        <ul className="text-gray-500 dark:text-gray-400 font-medium">
                            <li className="mb-4">
            ...
            <div className="sm:flex sm:items-center sm:justify-between">
                <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2025 Meszmate. All Rights Reserved.
                </span>
